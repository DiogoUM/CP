...
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t1}\mathrel{=}\conj{\conj{\uncurry{(\mathbin{+\!\!\!+})}\comp (\p1\times(\mathbin{/}\mathrm{2}))}{\p2\comp \p1}}{(\mathbin{/}\mathrm{2})\comp \p2}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t2}\mathrel{=}\conj{\conj{\p1\comp \p1}{\uncurry{(\mathbin{+\!\!\!+})}\comp (\p2\times(\mathbin{/}\mathrm{2}))}}{(\mathbin{/}\mathrm{2})\comp \p2}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t3}\mathrel{=}(\Varid{id}\times\Varid{id})\times(\mathbin{/}\mathrm{2}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
