...
\begin{eqnarray*}
\start
    \ensuremath{\begin{lcbr}(\Varid{q}\;\Varid{d})\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{0}}}{(\equiv \mathrm{0})\comp \p2\comp \p2\to (\succ )\comp \p1,\p1}\comp \Conid{F}\;\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}\\(\Varid{r}\;\Varid{d})\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{0}}}{(\equiv \mathrm{0})\comp \p2\comp \p2\to \underline{\mathrm{0}},(\succ )\comp \p1\comp \p2}\comp \Conid{F}\;\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}\end{lcbr}\;(\Varid{c}\;\Varid{d})\comp \mathbf{in}\mathrel{=}\alt{\underline{\Varid{d}}}{(\equiv \mathrm{0})\comp \p2\comp \p2\to \underline{\Varid{d}},(\mathbin{-}\mathrm{1})\comp \p2\comp \p2}\comp \Conid{F}\;\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}}
%
\just\equiv{ fokkinga }
%
    \ensuremath{\conj{(\Varid{q}\;\Varid{d})}{\conj{(\Varid{r}\;\Varid{d})}{(\Varid{c}\;\Varid{d})}}\mathrel{=}}
    \ensuremath{\cata{\conj{\alt{\underline{\mathrm{0}}}{(\equiv \mathrm{0})\comp \p2\comp \p2\to (\succ )\comp \p1,\p1}}{\conj{\alt{\underline{\mathrm{0}}}{(\equiv \mathrm{0})\comp \p2\comp \p2\to \underline{\mathrm{0}},(\succ )\comp \p1\comp \p2}}{(\alt{\underline{\Varid{d}}}{(\equiv \mathrm{0})\comp \p2\comp \p2\to \underline{\Varid{d}},(\mathbin{-}\mathrm{1})\comp \p2\comp \p2})}}}}
%
...
\xymatrix@C=2cm{
    \ensuremath{(\Conid{Tri}\times\N_0)}
           \ar[d]^-{\ensuremath{\conj{i_1\comp \p1}{i_2\comp \conj{\conj{\Varid{t1}}{\Varid{t2}}}{\Varid{t3}}}}}
\\
    \ensuremath{\Conid{Tri}\mathbin{+}(((\Conid{Tri}\times\N_0)\times(\Conid{Tri}\times\N_0))\times(\Conid{Tri}\times\N_0))}
}
\end{eqnarray*}
...
\xymatrix@C=2cm{
    \ensuremath{((\N_0\times\N_0)\times\N_0)\times\N_0}
           \ar[d]^-{\ensuremath{\conj{\conj{\uncurry{(\mathbin{+\!\!\!+})}\comp (\p1\times(\mathbin{/}\mathrm{2}))}{\p2\comp \p1}}{(\mathbin{/}\mathrm{2})\comp \p2}\times(\Varid{pred})}}
\\
    \ensuremath{((\N_0\times\N_0)\times\N_0)\times\N_0}
}
\end{eqnarray*}
...
\xymatrix@C=2cm{
    \ensuremath{((\N_0\times\N_0)\times\N_0)\times\N_0}
           \ar[d]^-{\ensuremath{\conj{\conj{\p1\comp \p1}{\uncurry{(\mathbin{+\!\!\!+})}\comp (\p2\times(\mathbin{/}\mathrm{2}))}}{(\mathbin{/}\mathrm{2})\comp \p2}\times(\Varid{pred})}}
\\
    \ensuremath{((\N_0\times\N_0)\times\N_0)\times\N_0}
}
\end{eqnarray*}
...
\xymatrix@C=2cm{
    \ensuremath{((\N_0\times\N_0)\times\N_0)\times\N_0}
           \ar[d]^-{\ensuremath{((\Varid{id}\times\Varid{id})\times(\mathbin{/}\mathrm{2}))\times(\Varid{pred})}}
\\
    \ensuremath{((\N_0\times\N_0)\times\N_0)\times\N_0}
}
\end{eqnarray*}
\\
\\
A junção destas funções depois destes procedimentos para representar os genes do hilomorfismo \ensuremath{\Varid{sierpinski}} é:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{6}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t1}\mathrel{=}\conj{\conj{\uncurry{(\mathbin{+\!\!\!+})}\comp (\p1\times(\mathbin{/}\mathrm{2}))}{\p2\comp \p1}}{(\mathbin{/}\mathrm{2})\comp \p2}\times(\Varid{pred}){}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t2}\mathrel{=}\conj{\conj{\p1\comp \p1}{\uncurry{(\mathbin{+\!\!\!+})}\comp (\p2\times(\mathbin{/}\mathrm{2}))}}{(\mathbin{/}\mathrm{2})\comp \p2}\times(\Varid{pred}){}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t3}\mathrel{=}((\Varid{id}\times\Varid{id})\times(\mathbin{/}\mathrm{2}))\times(\Varid{pred}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
